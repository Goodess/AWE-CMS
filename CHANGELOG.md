...
<li>В ПУ добавлены разделы: "Редактирование шаблонов", "Редактирование E-Mail шаблонов",<br>"Управление пользователями", "Управление группами", "Добавить группу" и "Рассылка E-Mail"</b></li>
